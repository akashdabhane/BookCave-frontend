...
export default function MyProfile() {
    ...
    const handleOnSaveClick = (event) => {
        ...
        try {
            axios.put(`${baseUrl}/users/update-info`, updateData, {
                withCredentials: true,
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('accessToken')}`
                }
            ...
            <div className="bg-white h-screen p-8 space-y-8 md:mx-[20%]">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-x-0 md:space-x-4 flex flex-col md:flex-row space-y-2">
                        <input type="text" name="firstname" id="firstname" onChange={inputChange}
                            className='rounded p-3 px-4 border border-blue-400' disabled={!editPersonalInfo} placeholder='enter your first name'
                            value={loggedInUser?.firstname}
                        />
                        <input type="text" name="lastname" id="lastname" onChange={inputChange}
                            className='rounded p-3 px-4 border border-blue-400' disabled={!editPersonalInfo} placeholder='enter your last name'
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-x-4 ">
                        <input type="email" name="email" id="email" onChange={inputChange}
                            className='rounded p-3 px-4 border border-blue-400'
                            disabled={!editEmail} placeholder='enter your email'
                ...
                <div className="flex flex-col md:flex-row items-center space-x-0 md:space-x-6 ">
                    <div className="w-full md:w-auto">
                        ...
                        <div className="space-x-4">
                            <input type="number" name="phoneNumber" id="phoneNumber" onChange={inputChange}
                                className='rounded p-3 px-4 border border-blue-400'
                                disabled={!editMobile} placeholder='phone number'
                    ...
                    <div className="w-full md:w-auto">
                        ...
                        <div className="space-x-4">
                            <input type="password" name="password" id="password" onChange={inputChange} value={loggedInUser?.password} className='rounded p-3 px-4 border border-blue-400' disabled={!editPassword} placeholder='password' />
